...
Form1.FDQuery2.Filter:='name='''+ComboBox1.Text+'''';
Form1.FDQuery2.Filtered:=true;
close;
end;
...
begin
ComboBox1.Items.AddObject(Form1.FDQuery1.FieldValues['name'],Pointer(StrToInt(Form1.FDQuery1.FieldValues['id'])));
  Form1.FDQuery1.next;
    Inc(i);
end;
  Form1.FDQuery1.SQL.Clear;
